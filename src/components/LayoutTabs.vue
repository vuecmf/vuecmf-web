<template>
  <div class="vuecmf-tabs">
    <el-button link title="左移动" class="vuecmf-tabs-arrow" @click="scrollLeft" :disabled="left_disabled"><el-icon><arrow-left-bold /></el-icon></el-button>
    ...
    <el-button link title="右移动" class="vuecmf-tabs-arrow" @click="scrollRight" :disabled="right_disabled"><el-icon><arrow-right-bold /></el-icon></el-button>
